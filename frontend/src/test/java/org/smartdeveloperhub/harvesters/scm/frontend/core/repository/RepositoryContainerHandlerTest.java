...
public class RepositoryContainerHandlerTest extends AbstractCappedContainerHandlerTestHelper {

	@Test
	public void testGet() throws Exception {
		super.verifyGetReturnsEmptyDataset(new RepositoryContainerHandler());
	}

	@Test
	public void testCreate() throws Exception {
		super.verifyFactoryMethodIsDisabled("repository",new RepositoryContainerHandler());
	}
