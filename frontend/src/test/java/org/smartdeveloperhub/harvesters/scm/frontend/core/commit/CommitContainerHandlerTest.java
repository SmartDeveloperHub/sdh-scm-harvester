...
public class CommitContainerHandlerTest extends AbstractCappedContainerHandlerTestHelper {

	@Test
	public void testGet() throws Exception {
		super.verifyGetReturnsEmptyDataset(new CommitContainerHandler());
	}

	@Test
	public void testCreate() throws Exception {
		super.verifyFactoryMethodIsDisabled("commit",new CommitContainerHandler());
	}
