...
//	public InputStream getCommits(String repoId, String branchId) throws Exception{
	public String getCommits(String repoId, String branchId) throws Exception{
		int attempts=0;
...
//	public InputStream getCommit(String repoId, String commitId) throws Exception{
	public String getCommit(String repoId, String commitId) throws Exception{
		int attempts=0;
		while(attempts<maxAttempts){
			attempts++;
			CloseableHttpClient httpclient = HttpClients.createDefault();	
...
//	public InputStream getCommits(String repoId) throws Exception {
	public String getCommits(String repoId) throws Exception {
		int attempts=0;
		while(attempts<maxAttempts){
			attempts++;
			CloseableHttpClient httpclient = HttpClients.createDefault();		 
